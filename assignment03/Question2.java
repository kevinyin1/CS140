...
public class Question2 {
	...
	@return 0 if the array of BankAccount1 is empty, null or all elements are null
	*/
	public static double averageBankBalance(BankAccount1[] accs) {
		...
		for (int i = 0; i < accs.length; i++){
			...
			if (nullCount == accs.length-1) return 0;
		}		
	...
	/**
 	...
 	first of them.
	@return null if the array of BankAccount1 is empty, null or all elements are null
	*/
	public static BankAccount1 lowestBankBalance(BankAccount1[] accs) {
		...
		for (int i = 0; i < accs.length; i++){
			...
			if(accs[i] == null) nullCount++;
			if (nullCount == accs.length-1) return null;
		}
	...
	*/
	...
	@return 0 if the array of Customer is empty, null or all elements are null
	*/
	...
	@return null if the array of Customer is empty, null or all elements are null
	*/
