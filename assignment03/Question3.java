...
public class Question3 {
	...
	/**
 	...
 	@return Optional Object with the value of the average of the balances of the accounts in accs
	@return empty Optional Object if the array of BankAccount1 is empty, null or all elements are null
	*/
	public static Optional<Double> averageBankBalance(BankAccount1[] accs) {
		if (accs == null) return Optional.empty();
		if (accs.length == 0) return Optional.empty();
		double totalBalance = 0, nullCount = 0;
		for (int i = 0; i < accs.length; i++){
			...
			if (nullCount == accs.length-1) return Optional.empty();
		}		
		return Optional.of((Double) (totalBalance / accs.length));
	...
	/**
 	...
 	Assume accs is not null or empty an no account in accs is null.
 	@param accs the array of BankAccount1 elements to examine
 	@return Optional object with the value of the bank account in the array accs that has the
	...
	*/
	public static Optional<BankAccount1> lowestBankBalance(BankAccount1[] accs) {
		...
		return Optional.of(lowestBalance);		
	}
	/**
 	...
 	@param accs the array of BankAccount1 elements to examine
 	@return Optional Object with the longest name of all the customerNames in
	...
	*/
	public static Optional<String> longestName(BankAccount1[] accs) {
		...
		return Optional.of(longest_name);		
	}
	/**
 	...
 	@return Optional Object with the average of the balances of the customer accounts of
 	the customers in accs
	@return empty Optional Object if the array of Customer is empty, null or all elements are null
	*/
	public static Optional<Double> averageCustomerBalance(Customer[] accs) {
		...
		return Optional.of(total_balance / accs.length);
	}
	/**
 	...
 	and no account in any Customer is null.
 	@param accs the array of Customer elements to examine
 	@return Optional Object with the Customer with the largest bank account in the array accs. 
	...
	*/
	public static Optional<Customer> greatestCustomerBalance(Customer[] accs) {
		...
		return Optional.of(greatestBalance);
	}
